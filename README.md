...
### [我的博客在这里 &rarr;](https://likewind.top)
...
* 如果你喜欢我的这个博客模板，请在`ilikewind/Myblog`这个repository点个赞——右上角**star**一下。
...
看右边:
![](http://likewind.top/img/blog-sidebar.jpg)
...
![](http://likewind.top/img/blog-keynote.jpg)
...
---
layout:     keynote
iframe:     "http://likewind.top/js-module-7day/"
---
```
...
ga_domain: likewind.top			# 默认的是 auto, 这里我是自定义了的域名，你如果没有自己的域名，需要改成auto。
```
...
我的博客标题是 **“WangW Blog”** 但是我想要在搜索的时候显示 **“王威的博客 | WangW Blog”** ，这个就需要SEO Title来定义了。

其实这个SEO Title就是定义了undefined<head><title>标题</title></head>这个里面的东西和多说分享的标题，你可以自行修改的。
